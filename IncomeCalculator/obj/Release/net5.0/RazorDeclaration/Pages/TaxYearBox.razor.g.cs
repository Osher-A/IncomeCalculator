...
#nullable restore
#line 17 "C:\Users\user\source\repos\IncomeCalculator\IncomeCalculator\Pages\TaxYearBox.razor"
       
	[Parameter]
	public string DisplayTaxYearBox { get; set; }
	[Parameter]
	public DateTime TaxYear { get; set; }
	[Parameter]
	public List<TaxYear> TaxYears { get; set; } = new List<TaxYear>();
